...
| 1.2 | Functional Requirements (4) | Tidak ada FR resmi untuk **User & Access Management** — FRD §2.7 terpaksa menelusuri fitur akun/otentikasi ke NFR-S03 sebagai *gap* sementara. | Ditambahkan **FR-09 (Manajemen Akun & Autentikasi Pengguna)**. FRD ditelusuri ulang ke FR-09 ini pada revisi FRD berikutnya, menutup gap traceability (lihat `docs/X_ProgressSummary.md` Temuan #3). |
