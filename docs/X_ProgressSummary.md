...
*Dokumen ini sebaiknya diperbarui ulang setiap kali salah satu dari 4 dokumen sumber naik versi mayor, setiap kali progres Tahap 3 Prototyping bertambah signifikan, atau setiap kali `README/3-DBSchema.md` mengalami revisi signifikan, agar tetap menjadi ringkasan yang akurat.*
